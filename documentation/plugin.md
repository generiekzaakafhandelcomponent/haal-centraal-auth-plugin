...
This is a Haal Centraal Auth Plugin demonstrating an API call action. It fetches data from a time API endpoint.
...
```kotlin
dependencies {
    implementation("com.ritense.valtimoplugins:haal-centraal-auth:0.0.1")
}
```
...
{
  "dependencies": {
    "@valtimo-plugins/haal-centraal-auth": "0.0.1"
  }
}
```
